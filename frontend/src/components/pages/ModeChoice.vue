  ...
  <div>
    <v-container>
      <v-row>
        <v-col>
          <v-card>
            <v-card-title>測定</v-card-title>
            <v-card-subtitle>モードを選んでください</v-card-subtitle>
          </v-card>
        </v-col>
      </v-row>
      <v-card to="/measure/myvoice">
        <v-card-title> マイVOICEを使う</v-card-title>
        <v-card-subtitle> 測定は１回で終わります</v-card-subtitle>
      </v-card>
